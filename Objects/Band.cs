...
namespace BandTracker.Objects
{
    public class Band
    {
        ...
        public List<Venue> GetUnrelatedVenues()
        {
            ...
            List<Venue> relatedVenues = this.GetVenues();
            List<Venue> allVenues = new List<Venue> {};
            while(rdr.Read())
            {
                int venueId = rdr.GetInt32(0);
                ...
                Venue newVenue = new Venue(venueName, venueLocation, venueId);
                if(relatedVenues.IndexOf(newVenue) < 0)
                {
                    allVenues.Add(newVenue);
                }
            }
        ...
        public void RemoveVenue(Venue selectedVenue)
        {
            SqlConnection conn = DB.Connection();
            conn.Open();
            ...
            venueIdParameter.Value = selectedVenue.Id;
